  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
          ...
          isDense: true,
          contentPadding: EdgeInsets.symmetric(horizontal: dSize(.04),vertical: dSize(.035)),
        ...
        fontWeight: FontWeight.w500,
          ...
          suffixIcon: widget.obscure
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal:dSize(.04), vertical: dSize(.03)),
              child: Icon(_obscure?Icons.remove_red_eye_outlined:Icons.remove_red_eye,
                  size: dSize(.06),
